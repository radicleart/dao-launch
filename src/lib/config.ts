...
export const config: { [key: string]: Config } = {
    "devnet": {
        ...
        VITE_HEADER_LINKS: [
            ...
            {name: '/sip', href: 'http://localhost:8080/sip', display: 'Upcoming SIPs', target:'_self'},
            ...
            {name: 'http://localhost:8080/proposals', href: '/dao/proposals', display: 'Proposals', target:'_self'},
    ...
    "testnet": {
        ...
        VITE_BRIDGE_API: 'https://api.testnet.stx.eco/bridge-api',
